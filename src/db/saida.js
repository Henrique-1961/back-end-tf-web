...
async function insertSignature(data) {
    const client = await connect();
    const query = "INSERT INTO saida (aluno, destino, dataSaida, horaSaida, horaChegada, dataChegada, pai, ativo) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING id";
    const ob = [data.aluno, data.destino, data.dataSaida, data.horaSaida, data.horaChegada, data.dataChegada, data.pai, true];
